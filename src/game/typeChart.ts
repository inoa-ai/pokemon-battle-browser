...
const chart: Partial<Record<ElementType, Partial<Record<ElementType, number>>>> = {
  ...
  Fire: { Grass: 2, Ice: 2, Steel: 2, Fire: 0.5, Water: 0.5, Dragon: 0.5 },
  ...
  Fighting: { Normal: 2, Ice: 2, Dark: 2, Steel: 2, Poison: 0.5, Flying: 0.5, Psychic: 0.5, Ghost: 0 },
  Poison: { Grass: 2, Poison: 0.5, Ground: 0.5, Ghost: 0.5, Steel: 0 },
  ...
  Steel: { Ice: 2, Steel: 0.5, Fire: 0.5, Water: 0.5, Electric: 0.5 },
};
